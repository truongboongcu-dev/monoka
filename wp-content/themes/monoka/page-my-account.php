        ...
        <?php if ( is_user_logged_in() ) : ?>
            ...
            <div class="order-card">
                <div id="user-TT" class="user-TT">
                    <div class="user-TT-item">
                        <div class="user-TT-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path fill="#be2a32" d="M320 312C386.3 312 440 258.3 440 192C440 125.7 386.3 72 320 72C253.7 72 200 125.7 200 192C200 258.3 253.7 312 320 312zM290.3 368C191.8 368 112 447.8 112 546.3C112 562.7 125.3 576 141.7 576L498.3 576C514.7 576 528 562.7 528 546.3C528 447.8 448.2 368 349.7 368L290.3 368z"></path></svg>
                        </div>
                    ...
                    <div class="user-TT-item">
                        ...
                        <div class="user-TT-text"><?php echo esc_html( get_user_meta( $current_user->ID, 'billing_phone', true ) ?: 'Chưa cập nhật' ); ?></div>
                        <div class="user-TT-edit inline-edit" data-field="billing_phone" style="cursor:pointer;">
                            <img class="user-TT-edit-img" src="<?php bloginfo("stylesheet_directory"); ?>/assets/img/icon/edit.png">
                        </div>
                    </div>
                    ...
                    <div class="user-TT-item">
                        ...
                        <div class="user-TT-text"><?php echo esc_html( get_user_meta( $current_user->ID, 'billing_address_1', true ) ?: 'Chưa cập nhật' ); ?></div>
                        <div class="user-TT-edit inline-edit" data-field="billing_address_1" style="cursor:pointer;">
                            <img class="user-TT-edit-img" src="<?php bloginfo("stylesheet_directory"); ?>/assets/img/icon/edit.png">
                        </div>
                    </div>
                ...
                jQuery(document).ready(function($) {
                    ...
                    var cancel_nonce = "<?php echo wp_create_nonce('litesite-cancel-order-nonce'); ?>";
                    ...
                    $('.inline-edit').on('click', function() {
                        ...
                        var saveBtnHtml = '<button class="inline-save" style="background: #be2a32; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer; margin-left: 5px; font-size: 13px;">Lưu</button>';
                    ...
                    // 2. Chuyển hướng cho các trường cốt lõi
                    $('.redirect-edit').on('click', function() {
                        window.location.href = "<?php echo esc_url( wc_customer_edit_account_url() ); ?>";
                    });

                    // VẤN ĐỀ 2: Xử lý Hủy đơn hàng bằng AJAX mượt mà
                    $(document).on('click', '.btn-cancel-ajax', function(e) {
                        e.preventDefault();
                        var $btn = $(this);
                        var orderId = $btn.data('order-id');

                        if (confirm('Bạn có chắc chắn muốn hủy đơn hàng này? Hành động này không thể hoàn tác.')) {
                            $btn.text('Đang xử lý...').css('pointer-events', 'none').alpha = 0.6;

                            $.ajax({
                                url: ajaxurl,
                                type: 'POST',
                                data: {
                                    action: 'litesite_ajax_cancel_order',
                                    order_id: orderId,
                ...
                ?>
                        ...
                        <div class="order-header-info">
                            ...
                            <div class="oh-right">
                                ...
                                <?php if ( in_array($order_status, $allowed_cancel_statuses) ) : ?>
                                    <button class="btn-custom btn-cancel btn-cancel-ajax" data-order-id="<?php echo $order->get_id(); ?>" style="margin-top: 10px; border:none; display:block;">
                                         Hủy đơn hàng
                                    </button>
                                <?php endif; ?>
                            </div>
                ...
                ?>
                    <div style="margin: 20px 0px;">
                        <h1 style="margin: 0; color: #be2a32; font-size: 24px;">Lịch sử đơn hàng</h1>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right; white-space: nowrap;">
                                            <?php if ( in_array($order_status, $allowed_cancel_statuses) ) : ?>
                                                <button class="btn-custom btn-cancel btn-cancel-ajax" data-order-id="<?php echo $order->get_id(); ?>" style="border:none;">
                                                    Hủy
                                                </button>
                                            <?php endif; ?>
